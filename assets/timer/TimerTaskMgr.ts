...
import type { TimerTaskConfig } from 'db://ccgf-kit/timer/ITimerTaskMgr';

/**
 * 计时器管理器（Singleton）
 */
export class TimerTaskMgr extends Singleton<TimerTaskMgr> {
    ...
    private _config: TimerTaskConfig = {};

    /**
     * 初始化全局配置
     * @param config 计时器配置，重复调用会覆盖旧配置
     */
    public init(config?: TimerTaskConfig): void {
